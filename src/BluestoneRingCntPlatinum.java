	...
	public class BluestoneRingCntPlatinum {
		@Test
		public void ringplatinumcnt() throws InterruptedException {
			...
			WebElement menu = driver.findElement(By.xpath("//span[text()='Metal']"));
			...
			Thread.sleep(3000);
			WebElement wcnt = driver.findElement(By.xpath("//span[text()=' Platinum ']"));
			Thread.sleep(1000);

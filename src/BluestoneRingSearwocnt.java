...
public class BluestoneRingSearwocnt {
	@Test
	public void ringSearwocnt() throws InterruptedException {
		...
		WebElement menu = driver.findElement(By.xpath("//span[@class='title style-fill i-right']/span[contains(.,'Gender')]"));
		...
		Thread.sleep(3000);
		WebElement wcnt = driver.findElement(By.xpath("//span[text()=' Women ']"));
		Thread.sleep(1000);
